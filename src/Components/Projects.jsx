...
const ProjectCard = ({ icon, title, description, color, github, live }) => {
  ...
  return (
    <div
      className="relative bg-black rounded-sm p-8 overflow-hidden group cursor-pointer mx-2 shadow-lg shadow-whiteGlow flex flex-col justify-between w-80 min-h-[500px] mx-5 md:mx-0"
      ...
      <div className="relative z-10 flex flex-col flex-1">
        ...
        <div className="flex gap-4 mt-auto">
          <a
            ...
            className="relative flex items-center gap-2 px-6 py-3 bg-gray-700 text-white rounded-lg font-medium shadow-lg shadow-blue-500/50 overflow-hidden group/btn cursor-target"
          >
            <span
  ...
  const projects = [
    {
      ...
      live: "https://sih-kolam-website.vercel.app/",
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
      ...
      live: "https://hack-vent-frontend.vercel.app/",
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <div className="min-h-screen py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col justify-center items-center gap-4 md:flex-row justify-center">
